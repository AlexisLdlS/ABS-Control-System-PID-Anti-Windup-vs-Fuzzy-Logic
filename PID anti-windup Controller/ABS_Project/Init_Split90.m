...
P_ABSPressureRateMax = 1000;  % Maximum ABS pressure rate (bar/s)
...
% Function parameters
P_SplitMu_On           = true;  % Enhanced Split-mu function switch
P_SplitMuOnlyAtBraking = true;  % Enhanced Split-mu only at braking switch
...
P_RefLine_On           = true;  % Show a reference line in the XY PLOTTER
...
% Steering wheel input (comment below lines to have a constant input of 0)
