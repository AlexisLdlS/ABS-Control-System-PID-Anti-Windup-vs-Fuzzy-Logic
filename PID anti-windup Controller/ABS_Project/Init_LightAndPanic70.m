...
% Light braking at 70km/h followed by a panic apply                       %
% No steering correction                                                  %
% Quasi-homogenous high-mu (~0.87)                                        %
% *********************************************************************** %
...
Mu = [0.93 0.88 0.81 0.86]';    % Quasi-homogenous high-mu
...
t_Brake2 = 11;
k_Brake2 = t_Brake2/dT + 1;
t_Brake3 = 16;
k_Brake3 = t_Brake3/dT + 1;
...
% Brake
BrkPos(k_Brake+1:k_Brake2) = linspace(0, 0.2, (k_Brake2-k_Brake));
BrkPos(k_Brake2+1:k_Brake3) = 1;
BrkPos(k_Brake3+1:end) = 0.25;
